  ...
  if (actor.role !== "STUDENT") {
    return (
      <div className="mx-auto max-w-xl rounded-card border border-line bg-surface p-6">
        ...
        <h2 className="text-lg font-semibold text-ink">학부모 초대</h2>
  ...
  return (
    <div className="mx-auto grid max-w-4xl gap-5 lg:grid-cols-[340px_1fr]">
      <section className="rounded-card border border-line bg-surface p-5 lg:p-6">
        {/* 제목은 h2부터 — h1은 상단바가 이미 그린다. */}
        <h2 className="text-lg font-semibold text-ink">가입코드 만들기</h2>
        <p className="mt-1 mb-6 text-caption text-mut">
          이 코드로 가입한 학부모는 나와 연결됩니다.
        </p>
        <ParentInviteForm />
      </section>
